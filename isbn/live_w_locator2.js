            ...
            if ((code.length === 13 && code.substring(0, 3) === "978") || code.length === 10) { 
                ...
                $.ajax({
                    ...
                    success: function(xml) {
                        ...
                        rating = $(xml).find("average_rating").text();
                        if (rating >= 0 && rating <1.5 ) {
                            output = "https://apps.8thwall.com/mbdntufe/ARStar1"
                        }
                        else if (rating >= 1.5 && rating < 2.5 ) {
                            output = "https://apps.8thwall.com/mbdntufe/ARStar2"
                        }
                        else if (rating >= 2.5 && rating < 3.5 ) {
                            output = "https://apps.8thwall.com/mbdntufe/ARStar3"
                        }      
                        else if (rating >= 3.5 && rating < 4.5 ) {
                            output = "https://apps.8thwall.com/mbdntufe/ARStar4"
                        }      
                        else if (rating >= 4.5) {
                            output = "https://apps.8thwall.com/mbdntufe/ARStar5"
                        }           
                        else if (rating.length <= 0 ) {
                            output = "https://apps.8thwall.com/mbdntufe/ARStar0"
                        }
